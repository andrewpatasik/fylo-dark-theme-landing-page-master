...
export const Testimonial = () => {
  return (
    <ul className="relative flex flex-col sm:flex-row mx-5">
      <Image
        src="/images/bg-quotes.png"
        alt="quotes"
        width={0}
        height={0}
        className="absolute w-5 h-5 left-4 -top-5"
      />
      <li className="testimonial-card flex flex-col space-y-5 py-8 px-5 rounded mx-3 mb-8">
        <div>
